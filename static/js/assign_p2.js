...
// ##### description เปลี่ยนไปตามที่เลือก dropdown (template)
    const templateDetails = {
        ...
        "s1-2": {
            t1: { text: "คำกิริยา: กิน อาบ หิว ดู เดิน วิ่ง ฟัง ร้อน นอน ตื่น", img: null },
            t2: { text: "คำนาม: ขา มือ โต๊ะ เตียง หนัง ขวด จาน ชาม ไฟ บ้าน", img: null },
            t3: { text: "คำ 2 พยางค์: ดินสอ ยางลบ กระเป๋า รองเท้า สมุด หมอนข้าง ตู้เย็น สบู่ ขนม ไฟฟ้า", img: null }
        },
        "s1-3": {
            t1: { text: "คำคล้าย: ตา ปลา กา หมา", img: null },
            t2: { text: "คำคล้าย: ไก่ ไข่ ไม่ ใจ", img: null },
            t3: { text: "คำคล้าย: หมู หู ปู งู", img: null }
        },
        "s1-4": {
            t1: { text: "ป้าแสงเป็นคนที่รักต้นไม้มาก ทุกเช้าเธอจะรดน้ำต้นไม้หน้าบ้าน ไม่ว่าจะฝนตกหรือแดดออก วันหนึ่งต้นมะลิของป้าแสงออกดอกสวยมากจนเพื่อนบ้านเดินผ่านก็ต้องชม ป้าแสงยิ้มอย่างมีความสุข เธอเด็ดดอกมะลิไปใส่แจกันในบ้าน และพูดกับต้นไม้ว่า “ขอบใจนะ ที่เติบโตให้ป้าดูทุกวัน”", img: null },
            t2: { text: "วันนั้นพยากรณ์อากาศแจ้งว่าฝนจะตก ลุงแม้นกำลังจะไปตลาด แต่ลืมร่มไว้ในบ้าน พอเดินไปถึงหน้าซอย ฝนก็ตกหนัก ลุงแม้นเลยวิ่งกลับมาหลบใต้ชายคาบ้านเพราะไม่มีร่ม เขานั่งรอจนฝนซา แล้วจึงเดินไปตลาดใหม่ ถึงแม้จะเปียกนิดหน่อย แต่ลุงแม้นก็ยังอารมณ์ดี", img: null },
            t3: { text: "พี่แป้งตื่นเช้ามาทำกับข้าวให้แม่ พี่แป้งคิดไม่ออกว่าจะทำอะไรดี เลยเปิดตู้เย็นเจอไข่ 2 ฟองกับต้นหอมเล็กน้อย พี่แป้งเลยตอกไข่ ใส่ต้นหอม แล้วทอดเป็นไข่เจียวหอมกรุ่น แม่เดินออกมาจากห้องและพูดว่า “หอมจังเลยลูก น่ากินมาก” พี่แป้งยิ้มด้วยความภูมิใจ", img: null }
        },
        "s1-5": {
            t1: { text: "ตา หู จมูก ปาก มือ แขน ขา เท้า นิ้ว ฟัน เล็บ ข้อศอก เข่า ผม คิ้ว ลิ้น", img: null },
            t2: { text: "จาน ชาม ช้อน ส้อม มีด แก้วน้ำ หม้อ กระทะ ตู้เย็น ถังขยะ แปรงสีฟัน ยาสีฟัน แชมพู โถส้วม ฝักบัว เก้าอี้ โต๊ะ", img: null },
            t3: { text: "ตื่น แปรงฟัน ล้างหน้า อาบน้ำ แต่งตัว หวีผม กินข้าว ใส่รองเท้า ซักผ้า ล้างจาน เดิน วิ่ง ยืน นั่ง นอน เล่นโทรศัพท์", img: null }
        },
        "s1-6": {
            t1: { text: "ประโยคในชีวิตประจำวัน เช่น กินข้าวแล้ว ไปอาบน้ำ ล้างมือก่อน ตื่นได้แล้ว และอื่น ๆ", img: null },
            t2: { text: "ประโยคในชีวิตประจำวันที่ยาวขึ้น เช่น ไปทานข้าวกันไหม วันนี้เป็นยังไงบ้าง อากาศดีจังเลย กลับบ้านดี ๆ นะ และอื่น ๆ", img: null },
            t3: { text: "ประโยคคล้องจอง เช่น สาวแสนสวยใส่สร้อยสามสิบสองเส้น และอื่น ๆ", img: null }
        },
        "s1-7": {
            t1: { text: "-", img: null },
            t2: { text: "-", img: null },
        ...
        "s1-8": {
            t1: { text: "ประโยคในชีวิตประจำวัน เช่น ไปทานข้าวกันไหม วันนี้เป็นยังไงบ้าง", img: null },
            t2: { text: "ประโยคในชีวิตประจำวันที่ยาวขึ้น เช่น เมื่อเช้านี้ฉันตื่นสาย ฉันกำลังจัดห้องทำงานใหม่", img: null },
            t3: { text: "ประโยคในชีวิตประจำวันที่ยาวขึ้นอีก เช่น ฉันวางแผนว่าจะเริ่มเรียนภาษาที่สามในปีหน้า", img: null }
        },
        "s1-9": {
            t1: { text: "-", img: null },
            t2: { text: "-", img: null },
